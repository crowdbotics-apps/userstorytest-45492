"""
Django settings for userstorytest_45492 project.
...
ROOT_URLCONF = 'userstorytest_45492.urls'
...
WSGI_APPLICATION = 'userstorytest_45492.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "userstorytest_45492 API",
    "DESCRIPTION": "API documentation for userstorytest_45492 App",
    "VERSION": "v1",
}
